...
import { MapPin, Building2, Globe, Users, HelpCircle, MessageSquarePlus } from "lucide-react";
import {
  useThreads,
  useVoteThread,
  useSubscriptions,
            ...
            <div className="text-center py-16 px-6">
              <div className="max-w-md mx-auto">
                ...
                <p className="text-xs text-gray-400 dark:text-gray-500 mb-6">
                  — {t(`emptyQuoteAttribution_${Math.floor(Date.now() / 86400000) % 7}`, {
                    defaultValue: "",
                  })}
                </p>
                {currentUser ? (
                  <button
                    onClick={() => {
                      const form = document.querySelector('[data-guide="agora-newthread"]');
                      if (form) {
